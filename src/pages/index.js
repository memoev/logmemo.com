  ...
  return (
    <>
      ...
      <div className="me">
        ...
        <p>
          Most things I write are not meant to be professional heavy documents, but just a set of key words that make sense with some examples, which allows me to link things in my head.
        </p>
        <p>
          I have a couple of personal projects going on, you can check it out <a href="https://github.com/memoev">here</a>. Also feel free to reach out via <a href="mailto:memoevh@gmail">email</a> or <a href="https://twitter.com/memoevh">twitter</a>.
        </p>
      </div>
      <Footer />
    </>
